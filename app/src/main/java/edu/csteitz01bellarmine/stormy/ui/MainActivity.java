...
import edu.csteitz01bellarmine.stormy.Weather.Current;
import edu.csteitz01bellarmine.stormy.Weather.Forecast;
import edu.csteitz01bellarmine.stormy.Weather.Hour;
import edu.csteitz01bellarmine.stormy.databinding.ActivityMainBinding;
import okhttp3.Call;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getForecast(double latitude, double longitude) {
        final ActivityMainBinding binding = DataBindingUtil.setContentView(MainActivity.this,
                edu.csteitz01bellarmine.stormy.R.layout.activity_main);

        iconImageView = findViewById(R.id.iconImageView);

        TextView darkSky = findViewById(edu.csteitz01bellarmine.stormy.R.id.darkSkyAttribution);
        darkSky.setMovementMethod(LinkMovementMethod.getInstance());

        String apiKey = "fc45aea8aacb60a5074324dd91446c79";
    ...
    private boolean isNetworkAvailable() {
        ...
        if (networkInfo != null && networkInfo.isConnected()){
            ...
            Toast.makeText(this, getString(edu.csteitz01bellarmine.stormy.R.string.network_unavailable_message),
                    Toast.LENGTH_LONG).show();
        }
        return isAvailable;
    }
    ...
    public void hourlyOnClick(View view) {
        ...
        intent.putExtra("Hourly list", (Serializable) hours);
